...
model_file_path = 'e02_logistic_regression_model.pkl'
vectorizer_file_path = 'e02_tfidf_vectorizer.pkl'
...
if os.path.exists(model_file_path) and os.path.exists(vectorizer_file_path):
    ...
    pan_training_conversations = parse_conversations(
...
pan_test_conversations = parse_conversations(
